...
unset($__errorArgs, $__bag); ?>" name="image" />
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="supplier_id" name="supplier_id" >
                                    ...
                                    <?php $__currentLoopData = $data['suppliers_']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Masukkan Judul Product" />
                            </div>
                            <div class="form-group mb-3">
...
unset($__errorArgs, $__bag); ?>" name="description" placeholder="Masukkan Description Product"></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
...
unset($__errorArgs, $__bag); ?>" name="price" placeholder="Masukkan Harga Product" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
...
unset($__errorArgs, $__bag); ?>" name="stock" placeholder="Masukkan Stock Product" />
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH D:\laragon\www\laravelproyek\resources\views/products/create.blade.php ENDPATH**/ ?>